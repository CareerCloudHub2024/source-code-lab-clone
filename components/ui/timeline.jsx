          ...
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div
              ...
              <div
                ...
                <div
                  className="h-4 w-4 rounded-full bg-neutral-200 dark:bg-neutral-800 border border-neutral-200 border-neutral-300 dark:border-neutral-700 p-2 dark:border-neutral-800" />
              </div>
              <h3
